...
<head>
    ...
    <title>Agregar Área de expositores | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div>
        ...
        <div class="container">
            <h1 class="all-tittles"><small>Actualizar - Área de Expositores</small></h1>
        </div>
        ...
        <form method="post" enctype="multipart/form-data" action="php/actArea.php">
            ...
            <div class="form-row" style="margin-top: 4rem;">
                <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                    <img class="miniatura" src="data:image/jpg;base64, <?php echo base64_encode($archivo) ?>" alt="">
                </div>
                <div class="custom-file form-group col-md-8" style="margin-bottom: 4rem;">
                    <input type="file" accept="image/jpeg" class="custom-file-input validarArea"
                        title="El tamaño del logo debe ser de 3300 x 2550 pixeles." id="archivo" name="archivo"
                        lang="es" maxlength="1" required>
                    <label class="custom-file-label" for="customFileLang">Imagen de
                        <?php echo $nombre ?>
                    </label>
                </div>
                <div class="form-group col-md-2" style="margin-bottom: 2rem;">
