...
<body>
    ...
    <div class="container">
        <a href="formAgenda-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a>
    </div>
    <div class="container tablas">
        <table class="table table-hover tablas" style="display:block; overflow:auto; width: 100%; display:block">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM contacto LIMIT $offset, $registrosPorPagina";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $mostrar['tel1'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['tel2'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['correo1'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['correo2'] ?>
                        </td>
                        <td style="text-align: center;">
                            <a href="formAgenda-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        function preguntar(id) {
            window.location.href = "php/agenda-Del.php?id=" + id;
        }
    </script>
</body>
