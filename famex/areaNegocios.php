...
<head>
    ...
    <title>Área de Negocios | Feria Aeroespacial México</title>
    <!-- Favicon -->
        ...
        <section class="text-center">
            <div class="animation-left" style="width: 80%; margin:auto;">
                <h1 class="title-conteiner">
                    ...
                    <span class="title">Área de Negocios</span>
            ...
            <div class="col-sm-12 tab-content mb-2">
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <div class="tab-pane fade image-group" id="famex-<?php echo $mostrar['id'] ?>" role="tabpanel"
                        ...
                        <div class="row container-gale">
                            <?php
                            $baseN = "SELECT * FROM areanegocios WHERE idFamex = '" . $mostrar['id'] . "'";
                            $resultN = mysqli_query($conexion, $baseN);

                            while ($mostrarN = mysqli_fetch_array($resultN)) {
                                ?>
                                <div class="col-sm-4 position-relative mt-3 mb-2 image-container justify-content-center">
                                    <div class="ring">
                                        ...
                                        <div class="border-card" style="border: none;">
                                            <div class="slide">
