...
<body>
    ...
    <div class="container tablas">
        ...
        <form method="post" action="php/pais-Add.php" enctype="multipart/form-data">
            <?php
            ...
            if (isset($_GET['id'])) {
                ...
                $consulta = "SELECT * FROM paises WHERE id = $id";
                ...
                if ($resultado && mysqli_num_rows($resultado) > 0) {
                    ...
                    // Otros campos que deseas mostrar para actualizar
                } else {
                ...
                $nombre = "";
                $bandera = "";
                // Otros campos que deseas mostrar para agregar
            }
            ?>
            <div class="form-group">
                <label for="nombre">Nombre</label>
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Pais participante"
                    value="<?php echo $nombre ?>" maxlength="20" required>
            </div>

            <!-- Otros campos del formulario para agregar y actualizar -->
            <?php
            // Si es una actualización, mostrar el campo "id" oculto
            if (isset($id)) {
            ...
            <div class="form-row" style="margin-top: 4rem;">
                ...
                if (isset($id)) {
                    ...
                    <div class="form-group col-md-2" style="margin-bottom: 1rem;">
                        <img class="miniatura" src="data:image/jpg;base64, <?php echo base64_encode($bandera) ?>" alt="">
                    </div>
                    <div class="custom-file form-group col-md-6" style="margin-bottom: 1rem;">
                        <input type="file" accept="image/jpeg, image/png" class="custom-file-input validarBandera"
                            title="El tamaño de la Bandera debe ser de 800 x 450 pixeles." id="bandera" name="bandera" lang="es"
                            maxlength="1">
                        <label class="custom-file-label" for="customFileLang">Bandera del País</label>
                    </div>
                    <div class="form-group col-md-2" style="margin-bottom: 1rem;">
                    ...
                    ?>
                    <div class="custom-file form-group col-md-10" style="margin-bottom: 1rem;">
                        <input type="file" accept="image/jpeg, image/png" class="custom-file-input validarBandera"
                            title="El tamaño de la Bandera debe ser de 800 x 450 pixeles." id="bandera" name="bandera" lang="es"
