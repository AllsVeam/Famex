    ...
    <div class="container tablas">
        ...
        <table class="table table-hover" style="border-radius: 15px;">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM tiposer LIMIT $offset, $registrosPorPagina";
                $result = mysqli_query($conexion, $sql);

                // Obtener el total de registros
                $sqlTotal = "SELECT COUNT(*) AS total FROM tiposer";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            <a href="formTipServ-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
                            <a href="#" class="icon-bin" title="Borrar"
                                onclick="preguntar(id=<?php echo $mostrar['id'] ?>)">
                            </a>
                        </td>
                    </tr>
                    <?php
