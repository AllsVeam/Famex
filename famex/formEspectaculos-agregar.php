...
<body>
    ...
    <div class="container tablas">
        <form id="form" method="post" action="php/espectaculos-Add.php" enctype="multipart/form-data" onsubmit="return validarArchivos()">
            <?php
            ...
            if (isset($_GET['id'])) {
                ...
                $consulta = "SELECT * FROM espectaculos where id = $id";
                ...
                <div class="form-row">
                    ...
                    ?>
                        <div class="custom-file form-group col-md-10">
                            <input type="file" class="custom-file-input validarimg" id="imagenes<?php echo $i ?>" accept="image/png, image/jpeg" name="imagen[]" lang="es" required>
                            <label class="custom-file-label" for="customFileLang">Seleccionar Foto</label>
                        </div>
                        <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                            <div class="previewContainer" id="previewContainer1">
            ...
            ?>
            <div class="container-fluid h-100" style="margin-top: .2em;">
