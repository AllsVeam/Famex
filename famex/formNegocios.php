...
<body>
    ...
    <div class="container  d-flex justify-content-end p-0" style="width: 100%;">
        <form class="m-0" width="10%" method="post" action="formNegocios-agregar.php" enctype="multipart/form-data">
    ...
    <div class="row mt-0 justify-content-center mb-3 container" style="margin: auto;" >
        ...
        $sql = "SELECT * FROM areanegocios LIMIT $offset, $registrosPorPagina";
        $result = mysqli_query($conexion, $sql);

        // Obtener el total de registros
        $sqlTotal = "SELECT COUNT(*) AS total FROM areanegocios";
                ...
                <div class="ring">
                    ...
                    <div class="border-card-admin" style="border: none;">
                        ...
                        <div class="slide d-flex align-items-center justify-content-center text-light">
                            <p>Actualizar:</p>
                            <a href="formNegocios-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2 text-light" title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
                            <p>Eliminar:</p>
                            <a href="#" class="icon-bin text-light" title="Borrar" 
    ...
    <script type="text/javascript">
        function preguntar(id) {            
                window.location.href = "php/negocios-Del.php?id=" + id;            
        }
    </script>
</body>
