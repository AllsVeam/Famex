...
<head>
    ...
    <title>Usuarios | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="container">
        <a href="formUser-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a>
    </div>
            ...
            <tbody>
                ...
                while ($resultado = mysqli_fetch_array($consulta)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $resultado['apellidoPat'] ?>
                            <?php echo $resultado['apellidoMat'] ?>
                        </td>
                        <td>
                        ...
                        <td style="text-align: center;">
                            <a href="formUser-agregar.php?id=<?php echo $resultado['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
