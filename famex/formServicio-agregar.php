...
<head>
    ...
    <title>Agregar servicio | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div>
        ...
        <div class="container">
            ...
            $idServ = $_GET['id'];
            $consTit = "SELECT * FROM tiposer WHERE id = $idServ";
            $resTit = mysqli_query($conexion, $consTit);
            $titulo = mysqli_fetch_assoc($resTit);
    ...
    <div class="container tablas">
        ...
        <form method="post" action="php/servicio-Add.php" enctype="multipart/form-data">
            <?php
            ...
            if (isset($_GET['idSer'])) {
                ...
                $consulta = "SELECT * FROM servicios where id = $idTipoSer";
            ...
            if (isset($idTipoSer)) {
                echo '<input type="hidden" name="idTipoSer" value="' . $idTipoSer . '">';
            }
            ?>
            <!-- se recupera el id de los tipos de servicios para poder identificarlo -->
            <div class="form-row">
                <div class="form-group col-md-6">
                    <input type="hidden" class="form-control" id="idSer" name="idSer" value="<?php echo $idServ ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <select id="idFamex" name="idFamex" class="form-control" required>
                        <option id="idFamex" name="idFamex" value="<?php echo $idFamex ?>"><?php echo $famNombre ?>
                        </option>
                        <?php
            ...
            <div class="form-row">
                ...
                if (isset($idTipoSer)) {
                    ...
                    <div class="custom-file form-group col-md-8">
                        <input type="file" class="custom-file-input validarLogo" accept="image/png" id="logo" name="logo"
                            lang="es" title="El logo debe tener un tamaño de 3300 x 2550 pixeles">
                        <label class="custom-file-label" for="customFileLang">Seleccionar Logo del Servicio</label>
                    </div>
                    <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                    ...
                    <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                        <img class="miniatura" src="data:image/jpg;base64, <?php echo base64_encode($baner) ?>" alt="">
                    </div>
                    <div class="custom-file form-group col-md-8">
                        <input type="file" class="custom-file-input validarBaner" accept="image/jpeg" id="baner" name="baner"
                            lang="es" title="El Baner debe tener un tamaño de 800 x 1040 pixeles">
                        <label class="custom-file-label" for="customFileLang">Seleccionar Baner del Servicio</label>
                    </div>
                    <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                    ...
                    <div class="custom-file form-group col-md-10" style="margin-bottom: 2rem;">
                        <input type="file" class="custom-file-input validarLogo" accept="image/png" id="logo" name="logo"
                            lang="es" required title="El logo debe tener un tamaño de 3300 x 2550 pixeles">
                        <label class="custom-file-label" for="customFileLang">Seleccionar Logo del Servicio</label>
                    </div>
                    <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                        <div class="previewContainer" id="previewContainer1">
                    ...
                    <div class="custom-file form-group col-md-10" style="margin-bottom: 2rem;">
                        <input type="file" class="custom-file-input validarBaner" accept="image/jpeg" id="baner" name="baner"
                            lang="es" required title="El logo debe tener un tamaño de 800 x 1040 pixeles">
                        <label class="custom-file-label" for="customFileLang">Seleccionar Baner del Servicio</label>
                    </div>
                    <div class="form-group col-md-2" style="margin-bottom: 2rem;">
                        <div class="previewContainer" id="previewContainer2">
