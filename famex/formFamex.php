...
<body>
    ...
    <div class="container">
        <a href="formFamex-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a>
    </div>
    <div class="container tablas">
        <table class="table table-hover" style="border-radius: 15px; overflow:auto; width: 100%;">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM famex ORDER BY id DESC LIMIT $offset, $registrosPorPagina";
                $result = mysqli_query($conexion, $sql);

                // Obtener el total de registros
                $sqlTotal = "SELECT COUNT(*) AS total FROM famex";
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $mostrar['año'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['mes'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['diaInicio'] ?>
                        </td>
                        <td>
                            <?php echo $mostrar['diaFinal'] ?>
                        </td>
                        <td>
                            <img height="50px" src="data:image/jpg;base64, <?php echo base64_encode($mostrar['logo']) ?>">
                        </td>
                        <td style="text-align: center;">
                            <a href="formFamex-agregar.php?id=<?php echo $mostrar['id'] ?>" title="Actualizar" class="icon-loop2"></a>&nbsp;&nbsp;&nbsp;
                            <a href="#" class="icon-bin" title="Borrar" onclick="modalEliminar('¿Estas seguro que desea borrar el registro?', '<?php echo $mostrar['id'] ?>')">
                            </a>
                        </td>
                    </tr>
                <?php
    ...
    <script type="text/javascript">
        function preguntar(id) {            
                window.location.href = "php/famex-del.php?id=" + id;            
        }
    </script>
</body>
