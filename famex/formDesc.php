...
<head>
    ...
    <title>Descargables | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div>
        ...
        <div class="container">
            <h1 class="all-tittles"><small>Descargables</small></h1>
        </div>
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <a href="formDesc-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
                            <?php
