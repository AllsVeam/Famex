...
<head>
    ...
    <title>Area Expositores | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div>
        ...
        <div class="container">
            <h1 class="all-tittles"><small>Área Expositores</small></h1>
        </div>
    ...
    <div class="container tablas">
        <!-- <a href="formTipServ-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a> -->
            ...
            <tbody>
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="data:image/jpg;base64, <?php echo base64_encode($mostrar['archivo']) ?>" height="30px" alt="" srcset="">                            
                        </td>
                        <td style="text-align: center;">
                            <a href="formAreaExp-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
                            <?php
                            if (isset($mostrar['archivo'])) {
                                ?>
                                <a href="php/visualizar_pdf.php?id=<?php echo $mostrar['id'] ?>" class="icon-file-pdf"
                                title="Visualizar" target="_blank"></a>
                                <?php                                
                            }else{
                                echo '<p style="color:red"><small>Carga el archivo</small></p>';
                            }                            
                            ?>
                        </td>
                    </tr>
    ...
    <script type="text/javascript">
        function preguntar(id) {
            if (confirm('¿Estas seguro que desea borrar el registro?')) {
                window.location.href = "php/tipSer-Del.php?id=" + id;
            }
        }
    </script>
</body>
