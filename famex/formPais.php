...
<head>
    ...
    <title>Paises | Feria Aeroespacial México</title>
    <!-- Favicon -->
...
<body>
    ...
    <div>
        ...
        <div class="container">
            <h1 class="all-tittles"><small>Países participantes</small></h1>
        </div>
    ...
    <div class="container tablas">
        <a href="formPais-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a>
        <table class="table table-hover" style="border-radius: 15px;">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM paises LIMIT $offset, $registrosPorPagina";
                $result = mysqli_query($conexion, $sql);

                // Obtener el total de registros
                $sqlTotal = "SELECT COUNT(*) AS total FROM paises";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="data:image/jpg;base64, <?php echo base64_encode($mostrar['bandera']) ?>" height="50px" alt="">
                        </td>
                        <td style="text-align: center;">
                            <!-- <a href="#?id=<?php echo $mostrar['id'] ?>" class="icon-file-text2" title="Detalle"></a>&nbsp;&nbsp;&nbsp; -->
                            <a href="formPais-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        function preguntar(id) {            
                window.location.href = "php/pais-Del.php?id=" + id;
            }
    </script>
</body>
