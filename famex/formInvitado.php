...
<body>
    ...
    <div class="container">
        <a href="formInvitado-agregar.php" style="float: right; padding: 15px;" class="icon-plus" title="Agregar"></a>
    </div>
    <div class="container tablas">
        <table class="table table-hover tablas" style="border-radius: 15px; overflow:auto; width: 100%;">
            <thead class="thead-light">
                <tr>
                    <th scope="col">ID</th>
                    <th scope="col">Famex</th>
                    <th scope="col">Invitado de Honor</th>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM invitadohonor ORDER BY id DESC LIMIT $offset, $registrosPorPagina";
                $result = mysqli_query($conexion, $sql);

                // Obtener el total de registros
                $sqlTotal = "SELECT COUNT(*) AS total FROM invitadohonor";
                ...
                while ($mostrar = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <img height="50px"
                                src="data:image/jpg;base64, <?php echo base64_encode($mostrar['imagen1']) ?>">
                        </td>
                        <td style="text-align: center;">
                            <a href="formInvitado-agregar.php?id=<?php echo $mostrar['id'] ?>" class="icon-loop2"
                                title="Actualizar"></a>&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        function preguntar(id) {
                window.location.href = "php/invitado-Del.php?id=" + id;
        }
    </script>
</body>
